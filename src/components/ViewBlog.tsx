...
function ViewBlog({
  ...
  return (
    <div className="z-30 absolute w-full h-full bg-[#000000a4] flex justify-center items-center">
      <div className="bg-white w-[836px] h-fit p-[25px] rounded-[25px] flex justify-between max-h-[85%] relative overflow-auto">
        ...
        <button
          ...
          className="absolute right-[25px] text-[#646464] text-base border border-[#646464] px-[10px] py-[5px] h-fit w-fit rounded-[10px] hover:border-black hover:text-black hover:font-semibold"
        >
          Esc
        </button>
      </div>
